  ...
  return (
    <div className="Wrapper">
      <div className="inWrapper">
          ...
          <div className="profileInfo" bis_skin_checked="1">
            ...
            <div className="profileBadge" bis_skin_checked="1">
              <div data-custom-domain="false" className="badgeLink" bis_skin_checked="1">
                <a className="MegaLink_megalink__u_TFB" href="http://amanhsn.framer.website" target="_blank" rel="noopener noreferrer" data-hover="false">
                  amanhsn.com
                </a>
              </div>
            </div>
        ...
        <a className="MegaLink_megalink__u_TFB" href="mailto:hello@ellencovey.com" target="_blank" rel="noopener noreferrer me" data-hover="true">syedamanhsn@gmail.com</a>
        ...
        <div bis_skin_checked="1">
        <a className="MegaLink_megalink__u_TFB" href="https://linkedin.com/in/amanhsn" target="_blank" rel="noopener noreferrer me" data-hover="true">amanhussain</a>
        <span style={{whiteSpace: 'nowrap'}}>﻿<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
